#!/usr/bin/env bash
# gateways/nginx/p09-resp-body/setup.sh
#
# Post-up smoke for nginx/p09-resp-body. Hits go-httpbin's /anything
...
say "nginx/p09-resp-body: waiting for ${DATA_URL}"
