#!/usr/bin/env bash
# gateways/wallarm/p06-rl-dynamic-low/setup.sh
#
# Bootstrap the p06-rl-dynamic-low policy profile via the Wallarm Admin API.
#
...
SERVICE_NAME="bench-p06-anything"
...
say "wallarm/p06-rl-dynamic-low ready"
