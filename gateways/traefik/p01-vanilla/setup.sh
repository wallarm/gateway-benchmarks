#!/usr/bin/env bash
# gateways/traefik/p01-vanilla/setup.sh
#
...
# mounted read-only at container start. There is nothing to
# bootstrap — this script only proves that traefik came up and
# proxies the backend correctly before parity attestation runs.
#
# Environment:
...
#    timing.
# -----------------------------------------------------------------------------
say "traefik/p01-vanilla: waiting for ${DATA_URL}"
