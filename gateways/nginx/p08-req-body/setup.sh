#!/usr/bin/env bash
# gateways/nginx/p08-req-body/setup.sh
#
# Post-up smoke for nginx/p08-req-body. Sends a probe that carries
# $.secret and asserts:
#   * response 200
...
say "nginx/p08-req-body: waiting for ${DATA_URL}"
