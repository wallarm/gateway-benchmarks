...
missing_code=$(curl --max-time 5 -s -o /tmp/kong-jwks.out -w '%{http_code}' \
...
valid_code=$(curl --max-time 5 -s -o /tmp/kong-jwks.out -w '%{http_code}' \
...
unknown_code=$(curl --max-time 5 -s -o /tmp/kong-jwks.out -w '%{http_code}' \
