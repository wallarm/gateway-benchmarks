#!/usr/bin/env bash
# gateways/wallarm/p03-rl-static/setup.sh
#
# Bootstrap the p03-rl-static policy profile via the Wallarm Admin API.
#
...
#                                 in the pinned 0.2.0 image; sliding with
#                                 window=1 produces the expected 429s.)
#   - rate:        1000
#   - window:      1
#   - ratelimit_key: static "bench-p03"
...
# -----------------------------------------------------------------------------
say "wallarm/p03-rl-static: bootstrap via ${ADMIN_URL}"
...
say "wallarm/p03-rl-static ready"
