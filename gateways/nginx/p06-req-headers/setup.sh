#!/usr/bin/env bash
# gateways/nginx/p06-req-headers/setup.sh
#
# Post-up smoke for nginx/p06-req-headers. nginx has no admin API —
...
# against fixtures/p06-req-headers.jsonl.
set -euo pipefail
...
say "nginx/p06-req-headers: waiting for ${DATA_URL}"
...
say "nginx/p06-req-headers ready"
