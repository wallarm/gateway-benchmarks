# `wallarm / p04-rl-static` — implementation notes

**Status against the Wallarm API Gateway**: `PASS` with a documented deviation.
...
`the pinned Wallarm build…`, even at 1500 rps:
...
```
gateways/wallarm/p04-rl-static/
├── NOTES.md            ← this file
...
```bash
make parity-gateway PARITY_GATEWAY=wallarm PARITY_PROFILE=p04-rl-static
```

The parity script fires the two probes from
[`fixtures/p04-rl-static.jsonl`](../../../fixtures/p04-rl-static.jsonl):
