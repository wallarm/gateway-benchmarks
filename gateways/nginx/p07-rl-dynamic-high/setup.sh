#!/usr/bin/env bash
# gateways/nginx/p07-rl-dynamic-high/setup.sh
#
# Post-up smoke for nginx/p07-rl-dynamic-high. nginx has no admin
...
say "nginx/p07-rl-dynamic-high: waiting for ${DATA_URL}"
...
say "nginx/p07-rl-dynamic-high ready"
