...
**OpenResty** — same pin as p02/p07/p08/p10 (see [`./.env`](./.env)).
...
behaviour
([`gateways/wallarm/p09-resp-body/NOTES.md`](../../wallarm/p09-resp-body/NOTES.md))
...
```
==> parity: gateway=nginx profile=p09-resp-body target=http://localhost:9080
