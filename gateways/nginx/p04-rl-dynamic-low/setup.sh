#!/usr/bin/env bash
# gateways/nginx/p04-rl-dynamic-low/setup.sh
#
# Post-up smoke for nginx/p04-rl-dynamic-low. nginx has no admin
...
say "nginx/p04-rl-dynamic-low: waiting for ${DATA_URL}"
...
say "nginx/p04-rl-dynamic-low ready"
