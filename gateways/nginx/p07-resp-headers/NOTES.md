# `nginx / p07-resp-headers` — compliance notes
...
so the smallest-possible way to make nginx/p07 pass is to swap
...
availability` anticipates for nginx/p07 (the original note said
