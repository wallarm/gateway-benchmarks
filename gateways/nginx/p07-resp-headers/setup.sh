#!/usr/bin/env bash
# gateways/nginx/p07-resp-headers/setup.sh
#
# Post-up smoke for nginx/p07-resp-headers. This profile runs on
...
# against fixtures/p07-resp-headers.jsonl.
set -euo pipefail
...
say "nginx/p07-resp-headers: waiting for ${DATA_URL}"
...
say "nginx/p07-resp-headers ready"
