...
31-column wide CSV (27 ranking columns + 4 bandwidth) plus a JSONL
superset and a short markdown rollup. Pure Go, so no jq / awk runtime
dependency on the loadgen host.
