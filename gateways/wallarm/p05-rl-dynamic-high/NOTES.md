# wallarm / p05-rl-dynamic-high — notes
...
Same vehicle as [p04](../p04-rl-dynamic-low/NOTES.md) — the built-in
...
See [`p04-rl-dynamic-low/NOTES.md`](../p04-rl-dynamic-low/NOTES.md)
for the rationale behind `scope: "service"` and
`window_type: "sliding"` on `0.2.0` — both are identical here.
...
```
==> parity: gateway=wallarm profile=p05-rl-dynamic-high target=http://localhost:9080
    fixture: fixtures/p05-rl-dynamic-high.jsonl
...
Same caveat as [p04](../p04-rl-dynamic-low/NOTES.md) — the parity
